...
class TestStatsController(BaseTestCase):
    ...
    def test_controller_get_stats_by_id_200(self):
        """ Test checks if get all stats conducted properly and return 200 status code. """
    ...
    def test_controller_get_stats_by_id_404(self):
    ...
    def test_controller_put_200(self):
    ...
    def test_controller_put_400(self):
    ...
    def test_controller_put_404(self):
    ...
    def test_controller_patch_200(self):
    ...
    def test_controller_patch_404(self):
